...
#include "edm4hep/DigiTrackHitAssociationCollection.h"
...
StatusCode PileupDigiTrackHitMergeTool::readPileupCollection(podio::EventStore& store) {
  ...
  const edm4hep::PositionedTrackHitCollection* hitCollection;
  const edm4hep::DigiTrackHitAssociationCollection* digiHitCollection;
  const edm4hep::MCParticleCollection* particleCollection;
...
StatusCode PileupDigiTrackHitMergeTool::mergeCollections() {
  ...
  edm4hep::PositionedTrackHitCollection* collHitsMerged = new edm4hep::PositionedTrackHitCollection();
  edm4hep::DigiTrackHitAssociationCollection* collDigiHitsMerged = new edm4hep::DigiTrackHitAssociationCollection();
  edm4hep::MCParticleCollection* collParticlesMerged = new edm4hep::MCParticleCollection();
