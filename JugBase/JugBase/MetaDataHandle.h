...
#ifndef JUGBASE_METADATAHANDLE_H
#define JUGBASE_METADATAHANDLE_H
...
template <typename T> std::string MetaDataHandle<T>::fullDescriptor() {
  ...
  if (nullptr != m_dataHandle) {
    full_descriptor = JugBase::metaDataHandleDescriptor(m_dataHandle->objKey(), m_descriptor);
...
#endif  // JUGBASE_METADATAHANDLE_H
