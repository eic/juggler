...
#include "eicd/ImagingMLHit.h"
#include "eicd/ImagingMLHitCollection.h"
...
class ImagingCalMLDataSorter : public GaudiAlgorithm {
public:
    ...
    DataHandle<eic::ImagingMLHitCollection>
        m_outputHitCollection{"outputHitCollection", Gaudi::DataHandle::Writer, this};

    // ill-formed: using GaudiAlgorithm::GaudiAlgorithm;
    ImagingCalMLDataSorter(const std::string& name, ISvcLocator* svcLoc)
...
}; // class ImagingCalMLDataSorter

DECLARE_COMPONENT(ImagingCalMLDataSorter)
