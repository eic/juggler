        ...
        StatusCode execute() override {
            ...
            //    }
                ...
                for (const auto& h : *rawhits) {
                    ...
                    if(eventReset < 2) {hitx.push_back(pos0.x - local_x_offset_station_2);} //use station 2 for both offsets since it is used for the reference orbit
                    else{hitx.push_back(pos0.x - local_x_offset_station_2);}
