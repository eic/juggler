...
void Jug::Reco::TestIRTAlgorithmServices::configure_QE_lookup_table(const std::vector<std::pair<double, double>> &QE_vector, 
								    unsigned nbins)
{
...
} // Jug::Reco::TestIRTAlgorithmServices::configure_QE_lookup_table()

// -------------------------------------------------------------------------------------

bool Jug::Reco::TestIRTAlgorithmServices::QE_pass(double ev, double rand) const
{
...
} // Jug::Reco::TestIRTAlgorithmServices::QE_pass()

// -------------------------------------------------------------------------------------

double Jug::Reco::TestIRTAlgorithmServices::GetDistance(const ParametricSurface *surface, 
...
} // Jug::Reco::TestIRTAlgorithmServices::GetDistance()

// -------------------------------------------------------------------------------------

bool Jug::Reco::TestIRTAlgorithmServices::GetCrossing(const ParametricSurface *surface, 
...
} // Jug::Reco::TestIRTAlgorithmServices::GetCrossing()

// -------------------------------------------------------------------------------------

TVector3 Jug::Reco::TestIRTAlgorithmServices::GetLocation(const eic::TrajectoryPoint *point) const
{
  return TVector3(point->position.x, point->position.y, point->position.z);
} // Jug::Reco::TestIRTAlgorithmServices::GetLocation()

// -------------------------------------------------------------------------------------

TVector3 Jug::Reco::TestIRTAlgorithmServices::GetMomentum(const eic::TrajectoryPoint *point) const
{
  ...
  return point->p.r*TVector3(sin(theta)*cos(phi), 
			     sin(theta)*sin(phi), 
			     cos(theta));
} // Jug::Reco::TestIRTAlgorithmServices::GetMomentum()
