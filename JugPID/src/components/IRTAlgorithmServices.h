...
namespace Jug::PID {
  ...
  protected:
    ...
    double GetDistance(const ParametricSurface *surface, const edm4eic::TrackPoint *point) const;
    bool GetCrossing(const ParametricSurface *surface, const edm4eic::TrackPoint *point, 
		     TVector3 *crs) const;
    TVector3 GetLocation(const edm4eic::TrackPoint *point) const;
    TVector3 GetMomentum(const edm4eic::TrackPoint *point) const;
