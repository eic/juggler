...
public:
  ...
  DataHandle<eic::ReconstructedParticleCollection> m_outputHitCollection{"SmearedReconstructedParticles",
                                                                         Gaudi::DataHandle::Writer, this};
  DataHandle<eic::ReconstructedParticleRelationsCollection> m_outputRelCollection{
      "SmearedReconstructedParticleRelations", Gaudi::DataHandle::Writer, this};
  ...
  MC2SmearedParticle(const std::string& name, ISvcLocator* svcLoc)
    ...
    declareProperty("outputCollection", m_outputHitCollection, "SmearedReconstructedParticles");
    declareProperty("outputRelations", m_outputRelCollection, "SmearedReconstructedParticles");
  }
  ...
  StatusCode execute() override {
    ...
    for (const auto& p : *parts) {
      ...
      eic::ReconstructedParticle rec_part{{ID++, algorithmID()},            // Unique index
