...
#include <EICrecon/algorithms/reco/InclusiveKinematicsTruth.h>
...
JUGALGO_DEFINE_ALGORITHM(InclusiveKinematicsTruth, eicrecon::InclusiveKinematicsTruth, Jug::Fast)
